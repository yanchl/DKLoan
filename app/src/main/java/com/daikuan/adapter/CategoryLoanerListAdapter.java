...
public class CategoryLoanerListAdapter extends BaseAdapter {
    ...
    public CategoryLoanerListAdapter(Context context,List<LoanItem> data){
        mContext = context;
...
//        mData.add(item);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        CategoryLoanerListAdapter.ViewHolder holder = null;
        if(convertView == null){
            convertView = mInflater.inflate(R.layout.loaner_list_item_category, parent, false);
            holder = new CategoryLoanerListAdapter.ViewHolder(convertView);
            convertView.setTag(holder);
        }else{
            holder = (CategoryLoanerListAdapter.ViewHolder) convertView.getTag();
        }
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Umeng.onEvent(mContext, Umeng.EVENTID_DAIKUAN_FENLEI,Umeng.EVENTID_DAIKUAN_FENLEI,item.getName());
    ...
    class ViewHolder{
        ...
        public TextView title,tag,personNum,moneyNum;
