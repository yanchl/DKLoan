...
//	public static String UA = "Mozilla/5.0 (iPhone; CPU iPhone OS 9_1 like Mac OS X) AppleWebKit/601.1.46 (KHTML, like Gecko) Mobile/13B143";
	...
	//贷款计算器
	public static String DaiKuanJiSuanQi = "http://51daikuan.org/index.php?s=/Mobile/calculator";	
